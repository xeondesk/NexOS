...
| `api/lib/stream-handlers.mjs` | Streaming ops | `chats.createStream` / `messages.sendStream` / `chats.resume` SSE handlers over the mock backend. |
